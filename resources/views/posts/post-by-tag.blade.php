<x-root-layout>
    ...
    <x-slot name="body">
        <div class="max-w-7xl mx-auto py-20 flex flex-col gap-6 min-h-screen" id="post-by-tag-page-wrrooter">
            <div
                class="flex text-teal-500 shadow-sm gap-2 items-center bg-teal-100 w-max h-max py-2 px-4 justify-center self-center rounded-md sm:scale-100 scale-75">
            ...
            <div
                class="bg-white dark:bg-zinc-800 sm:p-6 p-2 rounded-none sm:rounded-md shadow-sm flex gap-2 flex-wrap justify-center">
                @if (count($posts) == 0)
